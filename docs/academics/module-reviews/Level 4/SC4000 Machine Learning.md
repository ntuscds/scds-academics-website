...
The topics covered may already be familiar to you if you have taken other courses like [SC1015](../../Level 1/SC1015 Introduction to Data Science and AI.md) and [SC4020](SC4020 Data Analytics and Mining.md). New topics unique to this course may be Bayesian belief networks, density estimation and dimensionality reduction.
