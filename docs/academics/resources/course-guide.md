...
Generally the projects follow the topics of the course. For Introduction to Data Science and AI, you will have to make prediction models on a given dataset of your choice while for Software Engineering, you will have to create a web/mobile app using a toolkit of your choosing. You can check out the projects repository [here](https://github.com/NTU-DSAI/DSAI-Projects) for a full list of projects done thus far.
